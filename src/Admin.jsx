...
function DataSantri({ santri, headers, onRefresh }) {
          ...
          {list.map(s => (
            ...
            {editSantri === s.id ? (
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  <label style={{ ...btnGray, cursor: "pointer", display: "inline-block" }}>
  📷
  <input type="file" accept="image/*" style={{ display: "none" }} onChange={async (e) => {
    ...
    reader.onload = async () => {
      ...
      try {
        await axios.post(`${API}/santri/${s.id}/foto`, {
          foto_base64: base64,
          mime_type: file.type
        }, { headers });
...
function Pengingat({ santri, headers }) {
  ...
  {s.foto_url
    ? <img src={s.foto_url} alt={s.nama_siswa} style={{ width: 40, height: 40, borderRadius: "50%", objectFit: "cover", border: "2px solid #e2e8f0" }} />
